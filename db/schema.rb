...
ActiveRecord::Schema.define(version: 2019_11_09_110947) do
  ...
  create_table "gigs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "title"
    t.string "video"
