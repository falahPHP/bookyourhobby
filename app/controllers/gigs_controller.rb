class GigsController < ApplicationController
  ...
  if @step == 4 && @gig.photos.blank?
    return redirect_to request.referrer, flash: {error: "you dont have any photo"}
  end
  ...
  if @step == 5
    @gig.pricings.each do |pricing|
      ...
      if @gig.description.blank?
          ...
          return redirect_to edit_gig_path(@gig, step: 4), flash: {error: "You dont have any photo"}
        end
      end
